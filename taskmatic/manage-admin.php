            ...
            <table class="table table-codensed  display" id="example" style="width:100%">
              ...
              ?>
                <tr>
                  ...
                  <td><a class="btn btn-primary btn-sm" title="Update Admin" href="update-admin.php?admin_id=<?php echo $row['user_id']; ?>"><span class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;</td>
                </tr>
