    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title text-center">Add Employee Info</h3>
        </div>
      ...
      <div class="col-md-12">
        ...
        <div class="well well-custom">
          ...
          <?php } ?>
            <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-primary btn-menu" data-toggle="modal" data-target="#myModal">Add New Employee</button>
                </div>
              <?php } ?>
          ...
          <div class="table-responsive">
            <table  class="table table-codensed  display" id="example" style="width:100%">
              ...
              <tbody>
//  Author Name: Muhamad Diaz
 // for any PHP, Codeignitor, Laravel OR Python work contact me at mdarischeater@gmail.com 
 //Visit website : www.muhamaddiaz@gmail.com 
              <?php 
